...
💡 **提示**
【提示 | SCYTALE】 康喔跟柴柴常常傳遞一個棒子，也不確定是什麼，我們把它帶出來放在教室EC340 EC440 EC316
...
【提示 | INSTAGRAM】 橘子看著 INSTAGRAM 小編發出來的訊息，持續思考著訊息的正確性，還有那藏在文字間的意涵。提示 PYTHON] OsGa 看著眼前的 Python 程式，思考著如何跟股東們解釋，為什麼是 404 Not Found.提示 ASCII] 咪路看著眼前的密碼鎖，思考著是哪一串密碼。
