...
然而，就在今早11點55分左右，調查現場發生重大變故——根據現場目擊者指出，自稱為「SITCON 創辦人」的男子康喔，突然現身於打撈調查現場，並在未經許可的情況下，將關鍵證物——J0711班機的飛航紀錄器（黑盒子）帶離現場並引發爆炸。
...
【提示 | PYTHON】OsGa 看著眼前的 Python 程式，思考著如何跟股東們解釋，為什麼是 404 Not Found.
                https://camp-python-jail-game.joingame.cc/

【提示 | ASCII】咪路看著眼前的密碼鎖，思考著是哪一串密碼。
               https://camp-ascii.joingame.cc/

【提示 | MAZE】看著眼前密密麻麻的報導，嘗試著在這堆報導迷宮中，找出一條出路。
